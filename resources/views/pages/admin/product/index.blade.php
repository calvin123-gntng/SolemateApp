        ...
        @include('includes.pointer')
            <div class="flex items-center justify-between mb-4">
                <div>
                    ...
                    <small class="text-gray-400">List of product in store</small>
                </div>
                <a href="{{route('admin.product.new')}}" class="px-5 py-2 text-sm font-medium text-white bg-yellow-400 rounded focus:outline-none hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 me-2">
                    + New
                </a>
            </div>
                            ...
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{asset('storage/' . $item->image)}}" target="_blank">
                                        <img class="w-12 h-12 rounded" src="{{asset('storage/' . $item->image)}}" alt="shoe">
                                    </a>
                                    {{-- <img class="w-12 h-12 rounded" src="{{asset('assets/images/shoes.png')}}" alt="shoe"> --}}
                                </td>
                                ...
                                <td class="flex items-center gap-3 px-6 py-4">
                                    <a href="{{ route('admin.product.edit', $item->id) }}" class="flex gap-2 p-2 font-medium text-white bg-green-500 rounded fill-white">
                                    ...
                                    <a onclick="return confirm('Yakin ingin menghapus data ini?');" href="{{route('admin.product.delete', $item->id)}}" class="flex gap-2 p-2 font-medium text-white bg-red-500 rounded fill-white">
